...
export class SwirlDB {
    ...
    static withLocalStorage(storage_key) {
        const ptr0 = passStringToWasm0(storage_key, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
    ...
    static withIndexedDB(db_name) {
        const ptr0 = passStringToWasm0(db_name, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
    ...
    setValue(path, value) {
        try {
            ...
            const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            wasm.swirldb_setValue(retptr, this.__wbg_ptr, ptr0, len0, addHeapObject(value));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    getRootKeys() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.swirldb_getRootKeys(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    applyChanges(changes) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayJsValueToWasm0(changes, wasm.__wbindgen_export_0);
            const len0 = WASM_VECTOR_LEN;
            wasm.swirldb_applyChanges(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    getChanges() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.swirldb_getChanges(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayJsValueFromWasm0(r0, r1).slice();
            wasm.__wbindgen_export_3(r0, r1 * 4, 4);
    ...
    setStorageHint(path, hint) {
        try {
            ...
            const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(hint, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper167 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 4, __wbg_adapter_50);
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper610 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 138, __wbg_adapter_55);
        return addHeapObject(ret);
    };
